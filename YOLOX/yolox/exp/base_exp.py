...
class BaseExp(metaclass=ABCMeta):
    ...
    @abstractmethod
    def get_data_loader(
        self, batch_size: int, is_distributed: bool, for_domain_adaptation: bool
    ) -> Dict[str, torch.utils.data.DataLoader]:
        pass

    @abstractmethod
    def get_optimizer(self, batch_size: int, model_list=None) -> torch.optim.Optimizer:
        pass
