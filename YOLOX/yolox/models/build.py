...
_CKPT_FULL_PATH = {
    ...
    "yolox-l-weed": f"{_CKPT_ROOT_URL}/0.1.1rc0/yolox_l.pth",
...
def yolox_l_weed(pretrained: bool = True, num_classes: int = 12, device: str = None) -> nn.Module:
    return create_yolox_model("yolox-l-weed", pretrained, num_classes, device)
