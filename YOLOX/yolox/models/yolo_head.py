...
class YOLOXHead(nn.Module):
    ...
    def forward(self, xin, labels=None, imgs=None):
        ...
        if self.training:
            ...
            if cfg_da.use_domain_adaptation:
                #output_preds = torch.cat([x.flatten(start_dim=2) for x in output_preds], dim=2).permute(0, 2, 1)
                return loss_info, features, output_preds
            else:
                return loss_info
        else:
