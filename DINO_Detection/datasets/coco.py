...
def make_coco_transforms(image_set, fix_size=False, strong_aug=False, args=None):
    ...
    scales = data_aug_scales
    max_size = data_aug_max_size
    scales2_resize = data_aug_scales2_resize
    scales2_crop = data_aug_scales2_crop
    ...
    if image_set in ['val', 'eval_debug', 'train_reg', 'test', 'test_cross_season']:
...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "test_cross_season": (root / "test2017_cross_season", root / "annotations" / f'{mode}_WeedPlantsXXX_8skus_in_2021_cross_season.json' ),
    }
