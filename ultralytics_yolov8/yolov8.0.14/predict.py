...
class DetectionPredictor(BasePredictor):
    ...
    def postprocess(self, preds, img, orig_imgs, classes=None):
        ...
        for i, pred in enumerate(preds):
            ...
            results.append(Results(orig_img=orig_img, path=img_path, names=self.model.names, boxes=pred, orig_shape=shape[:2]))
        return results
