...
if sys_name == "Windows":
    ...
    start_t = 50
    end_t = 100
    model_dir_root = rf'D:\BoyangDeng\Detection\ultralytics_yolov8\runs\detect\train2017.2_{factor}_{start_t}_{end_t}'
    model_dir_root = rf'D:\BoyangDeng\Detection\ultralytics_yolov8\runs\detect\train2017.2_{factor}'
    if train_num <= 0:
