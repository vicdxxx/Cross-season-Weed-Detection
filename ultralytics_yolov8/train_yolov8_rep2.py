...
if sys_name == "Windows":
    ...
    if target_name == 'weed2021':
        data_dir = join(config_file_dir, 'weed_2021_rep2.yaml')
        ...
        data_dir = join(config_file_dir, 'weed_lambsquarters_rep2.yaml')
    workers = 0
else:
    """
...
if target_name == 'weed_lambsquarters':
    ...
    save_dirs = [
        './runs/detect/train2017_lambsquaters_generation',
        # './runs/detect/train',
        # './runs/detect/train2',
    ]
